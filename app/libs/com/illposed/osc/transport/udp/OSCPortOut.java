...
import com.communication.osc.transport.channel.OSCDatagramChannel;
...
public class OSCPortOut extends OSCPort {
	 ...
	 * using an {@link com.communication.osc.OSCSerializer}
	 * created from the given factory for converting the packets.
	 * @param serializerFactory used to create a single
	 *   {@link com.communication.osc.OSCSerializer} that is used to convert
